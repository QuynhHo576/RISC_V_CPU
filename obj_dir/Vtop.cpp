...
VL_INLINE_OPT void Vtop::_sequent__TOP__2(Vtop__Syms* __restrict vlSymsp) {
    ...
    VL_SIG8(__Vdlyvset__top__DOT__D_MEMORY__DOT__d_memory__v0,0,0);
    ...
    VL_SIG16(__Vdlyvdim0__top__DOT__D_MEMORY__DOT__d_memory__v0,9,0);
    ...
    VL_SIG64(__Vdlyvval__top__DOT__D_MEMORY__DOT__d_memory__v0,63,0);
    // Body
    ...
    __Vdlyvset__top__DOT__D_MEMORY__DOT__d_memory__v0 = 0U;
    ...
    // ALWAYS at dmem.sv:22
    if (vlTOPp->top__DOT__ControlUnit__DOT__mem_write) {
	__Vdlyvval__top__DOT__D_MEMORY__DOT__d_memory__v0 
	    = vlTOPp->top__DOT__regB_data_out;
	__Vdlyvset__top__DOT__D_MEMORY__DOT__d_memory__v0 = 1U;
	__Vdlyvdim0__top__DOT__D_MEMORY__DOT__d_memory__v0 
	    = (0x3ffU & (IData)((QData)((IData)((1U 
						 & (IData)(vlTOPp->top__DOT__ALU__DOT__result))))));
    }
    // ALWAYS at fetch.sv:137
    if (vlTOPp->reset) {
	__Vdly__top__DOT__fetch_inst__DOT__pc_fetch = 0U;
    } else {
	if ((0x40U == (IData)(vlTOPp->top__DOT__fetch_inst__DOT__index))) {
	    if ((((IData)(vlTOPp->top__DOT__pc_sel_out) 
		  | (2U == (IData)(vlTOPp->top__DOT__pc_sel_out))) 
		 | (VL_ULL(3) == vlTOPp->top__DOT__fetch_inst__DOT__pc))) {
		__Vdly__top__DOT__fetch_inst__DOT__pc_fetch 
		    = (0x3ffU & (IData)((QData)((IData)(
							(1U 
							 & (IData)(vlTOPp->top__DOT__ALU__DOT__result))))));
	    } else {
		if ((1U & (~ (IData)(vlTOPp->top__DOT__pc_sel_out)))) {
		    __Vdly__top__DOT__fetch_inst__DOT__pc_fetch 
	...
	if (((IData)(vlTOPp->top__DOT__ControlUnit__DOT__reg_write) 
	...
	if ((((IData)(vlTOPp->m_axi_rvalid) & (IData)(vlTOPp->m_axi_rready)) 
	    ...
	    if ((0x3e7U >= (0x3ffU & ((IData)(2U) + (IData)(vlTOPp->top__DOT__fetch_inst__DOT__index))))) {
    ...
    // ALWAYSPOST at dmem.sv:34
    if (__Vdlyvset__top__DOT__D_MEMORY__DOT__d_memory__v0) {
	vlTOPp->top__DOT__D_MEMORY__DOT__d_memory[__Vdlyvdim0__top__DOT__D_MEMORY__DOT__d_memory__v0] 
	    = __Vdlyvval__top__DOT__D_MEMORY__DOT__d_memory__v0;
    }
...
void Vtop::_settle__TOP__3(Vtop__Syms* __restrict vlSymsp) {
    ...
    if (((((((((0x33U == (IData)(vlTOPp->top__DOT__Decoder__DOT__opcode)) 
	       | (0x3bU == (IData)(vlTOPp->top__DOT__Decoder__DOT__opcode))) 
	...
	if (VL_UNLIKELY((0x33U == (IData)(vlTOPp->top__DOT__Decoder__DOT__opcode)))) {
	    vlTOPp->top__DOT__Decoder__DOT__imm_signed = VL_ULL(0);
	    vlTOPp->top__DOT__Decoder__DOT__imm_unsigned = VL_ULL(0);
		...
		if ((2U & (IData)(vlTOPp->top__DOT__Decoder__DOT__funct3))) {
			...
			if ((0U == (IData)(vlTOPp->top__DOT__Decoder__DOT__funct7))) {
			    ...
			    if ((1U == (IData)(vlTOPp->top__DOT__Decoder__DOT__funct7))) {
				vlTOPp->top__DOT__Decoder__DOT__decoded_instruction = VL_ULL(0x52454d55);
			...
			if ((0U == (IData)(vlTOPp->top__DOT__Decoder__DOT__funct7))) {
			    ...
			    if ((1U == (IData)(vlTOPp->top__DOT__Decoder__DOT__funct7))) {
				vlTOPp->top__DOT__Decoder__DOT__decoded_instruction = VL_ULL(0x52454d);
				vlTOPp->top__DOT__Decoder__DOT__alu_op = 0xdU;
			    }
			}
		    }
			...
			if ((0U == (IData)(vlTOPp->top__DOT__Decoder__DOT__funct7))) {
				...
				if ((1U == (IData)(vlTOPp->top__DOT__Decoder__DOT__funct7))) {
				    vlTOPp->top__DOT__Decoder__DOT__decoded_instruction = VL_ULL(0x44495655);
			...
			if ((0U == (IData)(vlTOPp->top__DOT__Decoder__DOT__funct7))) {
			    ...
			    if ((1U == (IData)(vlTOPp->top__DOT__Decoder__DOT__funct7))) {
				vlTOPp->top__DOT__Decoder__DOT__decoded_instruction = VL_ULL(0x444956);
				vlTOPp->top__DOT__Decoder__DOT__alu_op = 0xcU;
			    }
			}
		    }
		...
		if ((2U & (IData)(vlTOPp->top__DOT__Decoder__DOT__funct3))) {
		    if ((1U & (IData)(vlTOPp->top__DOT__Decoder__DOT__funct3))) {
			if ((0U == (IData)(vlTOPp->top__DOT__Decoder__DOT__funct7))) {
			    vlTOPp->top__DOT__Decoder__DOT__decoded_instruction = VL_ULL(0x534c5455);
			    vlTOPp->top__DOT__Decoder__DOT__alu_op = 9U;
			} else {
			    if ((1U == (IData)(vlTOPp->top__DOT__Decoder__DOT__funct7))) {
				vlTOPp->top__DOT__Decoder__DOT__decoded_instruction = VL_ULL(0x4d554c4855);
				vlTOPp->top__DOT__Decoder__DOT__alu_op = 0xbU;
			    }
			}
		    } else {
			if ((0U == (IData)(vlTOPp->top__DOT__Decoder__DOT__funct7))) {
			    vlTOPp->top__DOT__Decoder__DOT__decoded_instruction = VL_ULL(0x534c54);
			    vlTOPp->top__DOT__Decoder__DOT__alu_op = 8U;
			} else {
			    if ((1U == (IData)(vlTOPp->top__DOT__Decoder__DOT__funct7))) {
				vlTOPp->top__DOT__Decoder__DOT__decoded_instruction = VL_ULL(0x4d554c485355);
				vlTOPp->top__DOT__Decoder__DOT__alu_op = 0xbU;
			    }
			}
		    }
			...
			if ((0U == (IData)(vlTOPp->top__DOT__Decoder__DOT__funct7))) {
			    ...
			    if ((1U == (IData)(vlTOPp->top__DOT__Decoder__DOT__funct7))) {
				vlTOPp->top__DOT__Decoder__DOT__decoded_instruction = VL_ULL(0x4d554c48);
				vlTOPp->top__DOT__Decoder__DOT__alu_op = 0xbU;
			    }
			}
		    } else {
			if ((0U == (IData)(vlTOPp->top__DOT__Decoder__DOT__funct7))) {
				...
				if ((1U == (IData)(vlTOPp->top__DOT__Decoder__DOT__funct7))) {
				    vlTOPp->top__DOT__Decoder__DOT__decoded_instruction = VL_ULL(0x4d554c);
	    ...
	    VL_WRITEF("R-type %x :%x %s x%2#, x%2#, x%2#\n",
		      32,((IData)(vlTOPp->top__DOT__fetch_inst__DOT__pc_fetch) 
			  - (IData)(4U)),32,vlTOPp->top__DOT__if_instr,
	    ...
	    if (VL_UNLIKELY((0x3bU == (IData)(vlTOPp->top__DOT__Decoder__DOT__opcode)))) {
		vlTOPp->top__DOT__Decoder__DOT__imm_signed = VL_ULL(0);
		vlTOPp->top__DOT__Decoder__DOT__imm_unsigned = VL_ULL(0);
		if ((0U == (IData)(vlTOPp->top__DOT__Decoder__DOT__funct3))) {
		    if ((0U == (IData)(vlTOPp->top__DOT__Decoder__DOT__funct7))) {
			vlTOPp->top__DOT__Decoder__DOT__decoded_instruction = VL_ULL(0x41444457);
			vlTOPp->top__DOT__Decoder__DOT__alu_op = 0U;
		    } else {
			if ((0x20U == (IData)(vlTOPp->top__DOT__Decoder__DOT__funct7))) {
			    vlTOPp->top__DOT__Decoder__DOT__decoded_instruction = VL_ULL(0x53554257);
			    vlTOPp->top__DOT__Decoder__DOT__alu_op = 1U;
			} else {
			    if ((1U == (IData)(vlTOPp->top__DOT__Decoder__DOT__funct7))) {
				vlTOPp->top__DOT__Decoder__DOT__decoded_instruction = VL_ULL(0x4d554c57);
				vlTOPp->top__DOT__Decoder__DOT__alu_op = 0xaU;
			    }
			}
		    }
		    ...
		    if ((1U == (IData)(vlTOPp->top__DOT__Decoder__DOT__funct3))) {
			if ((0U == (IData)(vlTOPp->top__DOT__Decoder__DOT__funct7))) {
			    vlTOPp->top__DOT__Decoder__DOT__decoded_instruction = VL_ULL(0x534c4c57);
			    vlTOPp->top__DOT__Decoder__DOT__alu_op = 5U;
			}
		    } else {
			if ((4U == (IData)(vlTOPp->top__DOT__Decoder__DOT__funct3))) {
			    if ((1U == (IData)(vlTOPp->top__DOT__Decoder__DOT__funct7))) {
				vlTOPp->top__DOT__Decoder__DOT__decoded_instruction = VL_ULL(0x44495657);
				vlTOPp->top__DOT__Decoder__DOT__alu_op = 0xcU;
			    }
			} else {
			    if ((5U == (IData)(vlTOPp->top__DOT__Decoder__DOT__funct3))) {
				if ((0U == (IData)(vlTOPp->top__DOT__Decoder__DOT__funct7))) {
				    vlTOPp->top__DOT__Decoder__DOT__decoded_instruction = VL_ULL(0x53524c57);
				    vlTOPp->top__DOT__Decoder__DOT__alu_op = 6U;
				} else {
				    if ((0x20U == (IData)(vlTOPp->top__DOT__Decoder__DOT__funct7))) {
					vlTOPp->top__DOT__Decoder__DOT__decoded_instruction = VL_ULL(0x53524157);
					vlTOPp->top__DOT__Decoder__DOT__alu_op = 7U;
				    } else {
					if ((1U == (IData)(vlTOPp->top__DOT__Decoder__DOT__funct7))) {
					    vlTOPp->top__DOT__Decoder__DOT__decoded_instruction = VL_ULL(0x4449565557);
					    vlTOPp->top__DOT__Decoder__DOT__alu_op = 0xcU;
					}
				    }
				}
				...
				if ((6U == (IData)(vlTOPp->top__DOT__Decoder__DOT__funct3))) {
				    if ((1U == (IData)(vlTOPp->top__DOT__Decoder__DOT__funct7))) {
					vlTOPp->top__DOT__Decoder__DOT__decoded_instruction = VL_ULL(0x52454d57);
					vlTOPp->top__DOT__Decoder__DOT__alu_op = 0xdU;
				    }
				} else {
				    if ((7U == (IData)(vlTOPp->top__DOT__Decoder__DOT__funct3))) {
					if ((1U == (IData)(vlTOPp->top__DOT__Decoder__DOT__funct7))) {
					    vlTOPp->top__DOT__Decoder__DOT__decoded_instruction = VL_ULL(0x52454d5557);
					    vlTOPp->top__DOT__Decoder__DOT__alu_op = 0xdU;
					}
				    }
				}
		...
		VL_WRITEF("R64-type %x :%x %s x%2#, x%2#, x%2#\n",
			  32,((IData)(vlTOPp->top__DOT__fetch_inst__DOT__pc_fetch) 
			      - (IData)(4U)),32,vlTOPp->top__DOT__if_instr,
			  64,vlTOPp->top__DOT__Decoder__DOT__decoded_instruction,
			  5,(IData)(vlTOPp->top__DOT__Decoder__DOT__rd),
		...
		if (VL_UNLIKELY((0x13U == (IData)(vlTOPp->top__DOT__Decoder__DOT__opcode)))) {
			...
			= (IData)(vlTOPp->top__DOT__Decoder__DOT__imm_signed);
			...
			if ((2U & (IData)(vlTOPp->top__DOT__Decoder__DOT__funct3))) {
				...
				vlTOPp->top__DOT__Decoder__DOT__decoded_instruction = VL_ULL(0x534c5449);
				vlTOPp->top__DOT__Decoder__DOT__alu_op = 8U;
			    }
			} else {
			    if ((1U & (IData)(vlTOPp->top__DOT__Decoder__DOT__funct3))) {
		    ...
		    VL_WRITEF("I-type %x :%x %s x%2#, x%2#, %20d\n",
			      32,((IData)(vlTOPp->top__DOT__fetch_inst__DOT__pc_fetch) 
				  - (IData)(4U)),32,
			      vlTOPp->top__DOT__if_instr,
			      64,vlTOPp->top__DOT__Decoder__DOT__decoded_instruction,
			      5,(IData)(vlTOPp->top__DOT__Decoder__DOT__rd),
			      5,vlTOPp->top__DOT__Decoder__DOT__rs1,
			      64,vlTOPp->top__DOT__Decoder__DOT__imm_signed);
		} else {
			...
			if (VL_UNLIKELY((0x67U == (IData)(vlTOPp->top__DOT__Decoder__DOT__opcode)))) {
			    ...
			    vlTOPp->top__DOT__Decoder__DOT__alu_op = 0U;
			    VL_WRITEF("I-Type %x :%x     JALR x%2#, x%2#, %20d\n",
				      32,((IData)(vlTOPp->top__DOT__fetch_inst__DOT__pc_fetch) 
					  - (IData)(4U)),
				      32,vlTOPp->top__DOT__if_instr,
				      5,(IData)(vlTOPp->top__DOT__Decoder__DOT__rd),
				...
				vlTOPp->top__DOT__Decoder__DOT__funct7 = 0U;
				if ((0U == (IData)(vlTOPp->top__DOT__Decoder__DOT__funct3))) {
				    vlTOPp->top__DOT__Decoder__DOT__decoded_instruction = VL_ULL(0x4c42);
				} else {
				    if ((1U == (IData)(vlTOPp->top__DOT__Decoder__DOT__funct3))) {
					vlTOPp->top__DOT__Decoder__DOT__decoded_instruction = VL_ULL(0x4c48);
				    } else {
					if ((2U == (IData)(vlTOPp->top__DOT__Decoder__DOT__funct3))) {
						...
						if (
							...
							(5U 
							 == (IData)(vlTOPp->top__DOT__Decoder__DOT__funct3))) {
							vlTOPp->top__DOT__Decoder__DOT__decoded_instruction = VL_ULL(0x4c4855);
						    } else {
							if (
							    (6U 
							     == (IData)(vlTOPp->top__DOT__Decoder__DOT__funct3))) {
							    vlTOPp->top__DOT__Decoder__DOT__decoded_instruction = VL_ULL(0x4c5755);
							}
						    }
						}
					    }
				...
				VL_WRITEF("I-Type %x :%x %s x%2#, %20d(x%2#)\n",
					  32,((IData)(vlTOPp->top__DOT__fetch_inst__DOT__pc_fetch) 
					      - (IData)(4U)),
					  32,vlTOPp->top__DOT__if_instr,
					  64,vlTOPp->top__DOT__Decoder__DOT__decoded_instruction,
				...
				if (VL_UNLIKELY((0x23U 
				    ...
				    VL_WRITEF("S-Type %x :%x %s x%2#, %20d(x%2#)\n",
					      32,((IData)(vlTOPp->top__DOT__fetch_inst__DOT__pc_fetch) 
						  - (IData)(4U)),
					      32,vlTOPp->top__DOT__if_instr,
					      64,vlTOPp->top__DOT__Decoder__DOT__decoded_instruction,
					...
					vlTOPp->top__DOT__Decoder__DOT__imm 
					    = (IData)(vlTOPp->top__DOT__Decoder__DOT__imm_unsigned);
					VL_WRITEF("B-Type %x :%x %s x%2#, x%2#, %20#\n",
						  32,
						  ((IData)(vlTOPp->top__DOT__fetch_inst__DOT__pc_fetch) 
						   - (IData)(4U)),
						  32,
					...
					vlTOPp->top__DOT__Decoder__DOT__imm 
					    = (IData)(vlTOPp->top__DOT__Decoder__DOT__imm_signed);
					VL_WRITEF("B-Type %x :%x %s x%2#, x%2#, %20d\n",
						  32,
						  ((IData)(vlTOPp->top__DOT__fetch_inst__DOT__pc_fetch) 
						   - (IData)(4U)),
						  32,
	...
	if (VL_UNLIKELY((0x37U == (IData)(vlTOPp->top__DOT__Decoder__DOT__opcode)))) {
	    vlTOPp->top__DOT__Decoder__DOT__imm_signed 
		= (QData)((IData)((0xfffff000U & vlTOPp->top__DOT__if_instr)));
	    vlTOPp->top__DOT__Decoder__DOT__rs1 = 0U;
	    vlTOPp->top__DOT__Decoder__DOT__rs2 = 0U;
	    vlTOPp->top__DOT__Decoder__DOT__imm = (IData)(vlTOPp->top__DOT__Decoder__DOT__imm_signed);
	    vlTOPp->top__DOT__Decoder__DOT__funct7 = 0U;
	    vlTOPp->top__DOT__Decoder__DOT__funct3 = 0U;
	    vlTOPp->top__DOT__Decoder__DOT__decoded_instruction = VL_ULL(0x4c5549);
	    vlTOPp->top__DOT__Decoder__DOT__alu_op = 0xfU;
	    VL_WRITEF("U-type: %x :%x      LUI x%2#, %20d\n",
		      32,((IData)(vlTOPp->top__DOT__fetch_inst__DOT__pc_fetch) 
			  - (IData)(4U)),32,vlTOPp->top__DOT__if_instr,
		      5,(IData)(vlTOPp->top__DOT__Decoder__DOT__rd),
		      64,vlTOPp->top__DOT__Decoder__DOT__imm_signed);
		...
		vlTOPp->top__DOT__Decoder__DOT__alu_op = 0U;
		VL_WRITEF("U-Type %x :%x    AUIPC x%2#, %20d\n",
			  32,((IData)(vlTOPp->top__DOT__fetch_inst__DOT__pc_fetch) 
			      - (IData)(4U)),32,vlTOPp->top__DOT__if_instr,
			  5,(IData)(vlTOPp->top__DOT__Decoder__DOT__rd),
			  64,vlTOPp->top__DOT__Decoder__DOT__imm_signed);
		...
		if (VL_UNLIKELY((0x6fU == (IData)(vlTOPp->top__DOT__Decoder__DOT__opcode)))) {
		    ...
		    vlTOPp->top__DOT__Decoder__DOT__alu_op = 0U;
		    VL_WRITEF("J-Type %x :%x      JAL x%2#, %10#\n",
			      32,((IData)(vlTOPp->top__DOT__fetch_inst__DOT__pc_fetch) 
				  - (IData)(4U)),32,
			      vlTOPp->top__DOT__if_instr,
			      5,(IData)(vlTOPp->top__DOT__Decoder__DOT__rd),
...
void Vtop::_settle__TOP__6(Vtop__Syms* __restrict vlSymsp) {
    ...
    vlTOPp->top__DOT__regB_data_out = vlTOPp->top__DOT__RegisterFile__DOT__registers
	[vlTOPp->top__DOT__Decoder__DOT__rs2];
    vlTOPp->top__DOT__BranchCompare__DOT__branch_compare_regA_data_unsigned 
...
VL_INLINE_OPT void Vtop::_sequent__TOP__7(Vtop__Syms* __restrict vlSymsp) {
    ...
    vlTOPp->top__DOT__BranchCompare__DOT__branch_compare_regA_data_unsigned 
	= (1U & (IData)(vlTOPp->top__DOT__regB_data_out));
    // ALWAYS at control_logic.sv:38
    if (((((((((0x33U == (IData)(vlTOPp->top__DOT__Decoder__DOT__opcode)) 
	       | (0x13U == (IData)(vlTOPp->top__DOT__Decoder__DOT__opcode))) 
	      | (0x1bU == (IData)(vlTOPp->top__DOT__Decoder__DOT__opcode))) 
	     | (0x67U == (IData)(vlTOPp->top__DOT__Decoder__DOT__opcode))) 
	    | (0x6fU == (IData)(vlTOPp->top__DOT__Decoder__DOT__opcode))) 
	   | (3U == (IData)(vlTOPp->top__DOT__Decoder__DOT__opcode))) 
	  | (0x23U == (IData)(vlTOPp->top__DOT__Decoder__DOT__opcode))) 
	 | (0x63U == (IData)(vlTOPp->top__DOT__Decoder__DOT__opcode)))) {
	if ((0x33U == (IData)(vlTOPp->top__DOT__Decoder__DOT__opcode))) {
	    ...
	    vlTOPp->top__DOT__ControlUnit__DOT__alu_operand1_control = 0U;
	    vlTOPp->top__DOT__ControlUnit__DOT__alu_operand2_control = 0U;
	    vlTOPp->top__DOT__ControlUnit__DOT__mem_to_reg = 0U;
	    vlTOPp->top__DOT__ControlUnit__DOT__pcSel = 0U;
	} else {
	    if ((0x13U == (IData)(vlTOPp->top__DOT__Decoder__DOT__opcode))) {
		vlTOPp->top__DOT__ControlUnit__DOT__reg_write = 1U;
		vlTOPp->top__DOT__ControlUnit__DOT__mem_read = 0U;
		vlTOPp->top__DOT__ControlUnit__DOT__mem_write = 0U;
		vlTOPp->top__DOT__ControlUnit__DOT__alu_operand1_control = 0U;
		vlTOPp->top__DOT__ControlUnit__DOT__alu_operand2_control = 1U;
		vlTOPp->top__DOT__ControlUnit__DOT__mem_to_reg = 0U;
		vlTOPp->top__DOT__ControlUnit__DOT__pcSel = 0U;
	    } else {
		if ((0x1bU == (IData)(vlTOPp->top__DOT__Decoder__DOT__opcode))) {
		    vlTOPp->top__DOT__ControlUnit__DOT__reg_write = 1U;
		    vlTOPp->top__DOT__ControlUnit__DOT__mem_read = 0U;
		    vlTOPp->top__DOT__ControlUnit__DOT__mem_write = 0U;
		    vlTOPp->top__DOT__ControlUnit__DOT__alu_operand1_control = 0U;
		    ...
		    if ((0x67U == (IData)(vlTOPp->top__DOT__Decoder__DOT__opcode))) {
			vlTOPp->top__DOT__ControlUnit__DOT__reg_write = 1U;
			vlTOPp->top__DOT__ControlUnit__DOT__mem_read = 0U;
			vlTOPp->top__DOT__ControlUnit__DOT__mem_write = 0U;
			vlTOPp->top__DOT__ControlUnit__DOT__alu_operand1_control = 0U;
			vlTOPp->top__DOT__ControlUnit__DOT__alu_operand2_control = 1U;
			vlTOPp->top__DOT__ControlUnit__DOT__mem_to_reg = 2U;
			vlTOPp->top__DOT__ControlUnit__DOT__pcSel = 3U;
		    } else {
			if ((0x6fU == (IData)(vlTOPp->top__DOT__Decoder__DOT__opcode))) {
			    vlTOPp->top__DOT__ControlUnit__DOT__reg_write = 1U;
			    vlTOPp->top__DOT__ControlUnit__DOT__mem_read = 0U;
			    vlTOPp->top__DOT__ControlUnit__DOT__mem_write = 0U;
			    vlTOPp->top__DOT__ControlUnit__DOT__alu_operand1_control = 1U;
			    vlTOPp->top__DOT__ControlUnit__DOT__alu_operand2_control = 1U;
			    vlTOPp->top__DOT__ControlUnit__DOT__mem_to_reg = 2U;
			    vlTOPp->top__DOT__ControlUnit__DOT__pcSel = 2U;
			} else {
			    if ((3U == (IData)(vlTOPp->top__DOT__Decoder__DOT__opcode))) {
				vlTOPp->top__DOT__ControlUnit__DOT__reg_write = 1U;
				...
				if ((0x23U == (IData)(vlTOPp->top__DOT__Decoder__DOT__opcode))) {
				    vlTOPp->top__DOT__ControlUnit__DOT__reg_write = 0U;
				    vlTOPp->top__DOT__ControlUnit__DOT__mem_read = 0U;
				    vlTOPp->top__DOT__ControlUnit__DOT__mem_write = 1U;
				    vlTOPp->top__DOT__ControlUnit__DOT__alu_operand1_control = 0U;
				    vlTOPp->top__DOT__ControlUnit__DOT__alu_operand2_control = 1U;
				    vlTOPp->top__DOT__ControlUnit__DOT__mem_to_reg = 3U;
				    vlTOPp->top__DOT__ControlUnit__DOT__pcSel = 0U;
				} else {
				    vlTOPp->top__DOT__ControlUnit__DOT__reg_write = 0U;
				    vlTOPp->top__DOT__ControlUnit__DOT__mem_read = 0U;
				    ...
				    vlTOPp->top__DOT__ControlUnit__DOT__alu_operand1_control = 1U;
				    vlTOPp->top__DOT__ControlUnit__DOT__alu_operand2_control = 1U;
				    vlTOPp->top__DOT__ControlUnit__DOT__pcSel 
					= (((0x63U 
					     == (IData)(vlTOPp->top__DOT__Decoder__DOT__opcode)) 
					    & ((4U 
						& (IData)(vlTOPp->top__DOT__Decoder__DOT__funct3))
	...
	if ((0x37U == (IData)(vlTOPp->top__DOT__Decoder__DOT__opcode))) {
	    vlTOPp->top__DOT__ControlUnit__DOT__reg_write = 1U;
	    vlTOPp->top__DOT__ControlUnit__DOT__mem_read = 0U;
	    vlTOPp->top__DOT__ControlUnit__DOT__mem_write = 0U;
	    vlTOPp->top__DOT__ControlUnit__DOT__alu_operand1_control = 0U;
	    ...
	    if ((0x17U == (IData)(vlTOPp->top__DOT__Decoder__DOT__opcode))) {
		vlTOPp->top__DOT__ControlUnit__DOT__reg_write = 1U;
		vlTOPp->top__DOT__ControlUnit__DOT__mem_read = 0U;
		vlTOPp->top__DOT__ControlUnit__DOT__mem_write = 0U;
		vlTOPp->top__DOT__ControlUnit__DOT__alu_operand1_control = 0U;
...
void Vtop::_settle__TOP__8(Vtop__Syms* __restrict vlSymsp) {
    ...
    vlTOPp->top__DOT__ex_operand_1_in = ((IData)(vlTOPp->top__DOT__ControlUnit__DOT__alu_operand1_control)
					  ? (QData)((IData)(
							    ((IData)(vlTOPp->top__DOT__fetch_inst__DOT__pc_fetch) 
							     - (IData)(4U))))
					  : vlTOPp->top__DOT__regA_data_out);
    vlTOPp->top__DOT__ex_operand_2_in = ((IData)(vlTOPp->top__DOT__ControlUnit__DOT__alu_operand2_control)
					  ? (QData)((IData)(vlTOPp->top__DOT__Decoder__DOT__imm))
					  : vlTOPp->top__DOT__regB_data_out);
}
...
VL_INLINE_OPT void Vtop::_sequent__TOP__9(Vtop__Syms* __restrict vlSymsp) {
    ...
    vlTOPp->top__DOT__ex_operand_2_in = ((IData)(vlTOPp->top__DOT__ControlUnit__DOT__alu_operand2_control)
					  ...
					  : vlTOPp->top__DOT__regB_data_out);
    // ALWAYS at alu.sv:10
    vlTOPp->top__DOT__ALU__DOT__ex_operand_temp = (vlTOPp->top__DOT__ex_operand_1_in 
						   + vlTOPp->top__DOT__ex_operand_2_in);
    vlTOPp->top__DOT__ALU__DOT__result_add_word = (
						   ((QData)((IData)(
								    VL_NEGATE_I((IData)(
										(1U 
										& (IData)(
										(vlTOPp->top__DOT__ALU__DOT__ex_operand_temp 
										>> 0x1fU))))))) 
						    << 0x20U) 
						   | (QData)((IData)(vlTOPp->top__DOT__ALU__DOT__ex_operand_temp)));
    if (((((((((0U == (IData)(vlTOPp->top__DOT__Decoder__DOT__alu_op)) 
	       | (0xeU == (IData)(vlTOPp->top__DOT__Decoder__DOT__alu_op))) 
	      | (0xfU == (IData)(vlTOPp->top__DOT__Decoder__DOT__alu_op))) 
	...
	vlTOPp->top__DOT__ALU__DOT__result = ((0U == (IData)(vlTOPp->top__DOT__Decoder__DOT__alu_op))
					       ? (vlTOPp->top__DOT__ex_operand_1_in 
						  + vlTOPp->top__DOT__ex_operand_2_in)
					       : ((0xeU 
	...
	if ((6U == (IData)(vlTOPp->top__DOT__Decoder__DOT__alu_op))) {
	    vlTOPp->top__DOT__ALU__DOT__result = (vlTOPp->top__DOT__ex_operand_1_in 
						  >> 
						  (0x3fU 
						   & (IData)(vlTOPp->top__DOT__ex_operand_2_in)));
	} else {
	    if ((7U == (IData)(vlTOPp->top__DOT__Decoder__DOT__alu_op))) {
		vlTOPp->top__DOT__ALU__DOT__result 
		    = VL_SHIFTRS_QQI(64,64,6, vlTOPp->top__DOT__ex_operand_1_in, 
				     (0x3fU & (IData)(vlTOPp->top__DOT__ex_operand_2_in)));
	    } else {
		if ((0xaU == (IData)(vlTOPp->top__DOT__Decoder__DOT__alu_op))) {
		    vlTOPp->top__DOT__ALU__DOT__result 
			= (vlTOPp->top__DOT__ex_operand_1_in 
			   * vlTOPp->top__DOT__ex_operand_2_in);
		} else {
		    if ((0xbU == (IData)(vlTOPp->top__DOT__Decoder__DOT__alu_op))) {
			vlTOPp->top__DOT__ALU__DOT__result = VL_ULL(0);
		    } else {
			if ((0xcU == (IData)(vlTOPp->top__DOT__Decoder__DOT__alu_op))) {
			    vlTOPp->top__DOT__ALU__DOT__result 
				= VL_DIV_QQQ(64, vlTOPp->top__DOT__ex_operand_1_in, vlTOPp->top__DOT__ex_operand_2_in);
			} else {
			    if ((0xdU == (IData)(vlTOPp->top__DOT__Decoder__DOT__alu_op))) {
				vlTOPp->top__DOT__ALU__DOT__result 
				    = VL_MODDIV_QQQ(64, vlTOPp->top__DOT__ex_operand_1_in, vlTOPp->top__DOT__ex_operand_2_in);
			    }
			}
		    }
		}
...
void Vtop::_settle__TOP__10(Vtop__Syms* __restrict vlSymsp) {
    ...
    // ALWAYS at dmem.sv:14
    if (vlTOPp->top__DOT__ControlUnit__DOT__mem_read) {
	vlTOPp->top__DOT__ex_mem_read_data_out = vlTOPp->top__DOT__D_MEMORY__DOT__d_memory
	    [(0x3ffU & (IData)((QData)((IData)((1U 
						& (IData)(vlTOPp->top__DOT__ALU__DOT__result))))))];
    } else {
	vlTOPp->top__DOT__ex_mem_read_data_out = VL_ULL(0);
    }
}
...
void Vtop::_ctor_var_reset() {
    ...
    top__DOT__pc_sel_out = VL_RAND_RESET_I(1);
    top__DOT__regA_data_out = VL_RAND_RESET_Q(64);
    top__DOT__regB_data_out = VL_RAND_RESET_Q(64);
    top__DOT__ex_operand_1_in = VL_RAND_RESET_Q(64);
    top__DOT__ex_operand_2_in = VL_RAND_RESET_Q(64);
    top__DOT__ex_mem_read_data_out = VL_RAND_RESET_Q(64);
    ...
    top__DOT__fetch_inst__DOT__pcSel = VL_RAND_RESET_I(2);
    ...
    top__DOT__Decoder__DOT__imm_signed = VL_RAND_RESET_Q(64);
    top__DOT__Decoder__DOT__imm_unsigned = VL_RAND_RESET_Q(64);
    ...
    top__DOT__ControlUnit__DOT__alu_operand1_control = VL_RAND_RESET_I(1);
    top__DOT__ControlUnit__DOT__alu_operand2_control = VL_RAND_RESET_I(1);
    top__DOT__ControlUnit__DOT__pcSel = VL_RAND_RESET_I(2);
    top__DOT__ControlUnit__DOT__mem_to_reg = VL_RAND_RESET_I(2);
    { int __Vi0=0; for (; __Vi0<32; ++__Vi0) {
	    top__DOT__RegisterFile__DOT__registers[__Vi0] = VL_RAND_RESET_Q(64);
    }}
    top__DOT__RegisterFile__DOT__i = VL_RAND_RESET_I(32);
    top__DOT__BranchCompare__DOT__branch_compare_regA_data_unsigned = VL_RAND_RESET_I(1);
    top__DOT__BranchCompare__DOT__branch_compare_regB_data_unsigned = VL_RAND_RESET_I(1);
    top__DOT__ALU__DOT__result = VL_RAND_RESET_Q(64);
    top__DOT__ALU__DOT__ex_operand_temp = VL_RAND_RESET_Q(64);
    top__DOT__ALU__DOT__result_add_word = VL_RAND_RESET_Q(64);
    { int __Vi0=0; for (; __Vi0<1024; ++__Vi0) {
	    top__DOT__D_MEMORY__DOT__d_memory[__Vi0] = VL_RAND_RESET_Q(64);
    }}
